...
const ForgotPassword = ({ onClick }) =>
{
    ...
    return (
        <section className="bg-white border border-teal-600 dark:border-teal-900 dark:bg-slate-900 w-[90%] sm:w-[70%] lg:w-[50%] md:h-[50%] p-6 md:p-10 rounded-lg shadow-lg fixed z-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            {/* Close Button */}
            <button
                onClick={onClick}
                type="button"
            ...
            <p className=' text-xl md:text-3xl text-center font-semibold text-teal-900 dark:text-slate-100 mb-10'>Reset Password</p>
            <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" onSubmit={submitHandler}>
                <div className='relative mb-6'>
                    ...
                    <input
                        ...
                        className="bg-transparent border focus:outline-none border-teal-800 text-gray-900 dark:text-slate-50 text-sm rounded-lg  block w-full pl-10 p-2.5"
                ...
                <button
                    type="submit"
                    className=" text-white bg-teal-950 p-3 w-[70%] md:w-[50%] lg:w-[30%] rounded-full"
                >
